...
const interviewTemp =interviewers[4];
...
storiesOf("InterviewerList", module)
  ...
  .add("Edit", () => <Form student={"Alison Synchro"} interviewer={2} interviewers={interviewers} onSave={action("onSave")} onCancel={action("onCancel")} />)
